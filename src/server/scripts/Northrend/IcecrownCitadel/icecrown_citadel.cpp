...
class spell_icc_sprit_alarm : public SpellScriptLoader
{
    public:
        ...
        class spell_icc_sprit_alarm_SpellScript : public SpellScript
        {
            ...
            void Register() override
            {
                OnEffectHit += SpellEffectFn(spell_icc_sprit_alarm_SpellScript::HandleEvent, EFFECT_ALL, SPELL_EFFECT_SEND_EVENT);
            }
        };
...
class spell_icc_geist_alarm : public SpellScriptLoader
{
    public:
        ...
        class spell_icc_geist_alarm_SpellScript : public SpellScript
        {
            ...
            void Register() override
            {
                OnEffectHit += SpellEffectFn(spell_icc_geist_alarm_SpellScript::HandleEvent, EFFECT_ALL, SPELL_EFFECT_SEND_EVENT);
            }
        };
